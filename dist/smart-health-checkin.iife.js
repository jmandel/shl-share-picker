(() => {
  ...
  __export(exports_smart_health_checkin, {
    request: () => request,
    renderReturnUI: () => renderReturnUI,
    rehydrateResponse: () => rehydrateResponse,
    parseReturnHash: () => parseReturnHash,
    maybeHandleReturn: () => maybeHandleReturn,
